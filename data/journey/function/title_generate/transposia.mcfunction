...
#execute if data block ~ ~ ~ {front_text:{color:"white"}} run title @p[tag=!titled] title [{"nbt":"front_text.messages[0]","block":"~ ~ ~","interpret":true,"color":"#4E5C24","bold":false,"underlined":false,"font":"transposia:journey.white"}]

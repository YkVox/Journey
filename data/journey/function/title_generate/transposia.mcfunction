...
##SOUND
$execute if data block ~ ~ ~ {front_text:{color:"white"}} run execute as @p[tag=!$(material)] at @s run playsound transposia:journey.strings voice @s ~ ~ ~ 1 1
$execute if data block ~ ~ ~ {front_text:{color:"light_gray"}} run execute as @p[tag=!$(material)] at @s run playsound transposia:journey.silence voice @s ~ ~ ~ 1 1
$execute if data block ~ ~ ~ {front_text:{color:"gray"}} run execute as @p[tag=!$(material)] at @s run playsound transposia:journey.klank voice @s ~ ~ ~ 1 1
$execute if data block ~ ~ ~ {front_text:{color:"black"}} run execute as @p[tag=!$(material)] at @s run playsound transposia:journey.silence voice @s ~ ~ ~ 1 1
$execute if data block ~ ~ ~ {front_text:{color:"brown"}} run execute as @p[tag=!$(material)] at @s run playsound transposia:journey.cavalry voice @s ~ ~ ~ 1 1
$execute if data block ~ ~ ~ {front_text:{color:"red"}} run execute as @p[tag=!$(material)] at @s run playsound transposia:journey.horn voice @s ~ ~ ~ 1 1
$execute if data block ~ ~ ~ {front_text:{color:"orange"}} run execute as @p[tag=!$(material)] at @s run playsound transposia:journey.gold voice @s ~ ~ ~ 1 1
$execute if data block ~ ~ ~ {front_text:{color:"yellow"}} run execute as @p[tag=!$(material)] at @s run playsound transposia:journey.chord voice @s ~ ~ ~ 1 1
$execute if data block ~ ~ ~ {front_text:{color:"lime"}} run execute as @p[tag=!$(material)] at @s run playsound transposia:journey.bagpipes voice @s ~ ~ ~ 1 1
$execute if data block ~ ~ ~ {front_text:{color:"green"}} run execute as @p[tag=!$(material)] at @s run playsound transposia:journey.acorn voice @s ~ ~ ~ 1 1
$execute if data block ~ ~ ~ {front_text:{color:"cyan"}} run execute as @p[tag=!$(material)] at @s run playsound transposia:journey.chant voice @s ~ ~ ~ 1 1
$execute if data block ~ ~ ~ {front_text:{color:"light_blue"}} run execute as @p[tag=!$(material)] at @s run playsound transposia:journey.vibration voice @s ~ ~ ~ 1 1
$execute if data block ~ ~ ~ {front_text:{color:"blue"}} run execute as @p[tag=!$(material)] at @s run playsound transposia:journey.bell voice @s ~ ~ ~ 1 1
$execute if data block ~ ~ ~ {front_text:{color:"purple"}} run execute as @p[tag=!$(material)] at @s run playsound transposia:journey.piano voice @s ~ ~ ~ 1 1
$execute if data block ~ ~ ~ {front_text:{color:"magenta"}} run execute as @p[tag=!$(material)] at @s run playsound transposia:journey.fever voice @s ~ ~ ~ 1 1
$execute if data block ~ ~ ~ {front_text:{color:"pink"}} run execute as @p[tag=!$(material)] at @s run playsound transposia:journey.drum voice @s ~ ~ ~ 1 1